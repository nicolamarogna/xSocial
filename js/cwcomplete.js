...
var CwAutocompleter = new Class({
	...
	options: {		
		...
		inputMinLength: 1, // number of characters at which the auto completion starts
	...
	setValues: function(values)
	{
		...
		this.values.each( function(avalue, i) {
			if (avalue) {
				...
				this.lielems[i].addEvent('click', this.enterValue.bindWithEvent(this, {id: avalue[0], value: avalue[2] }));
